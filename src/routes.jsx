...
import FormBuilderManagement from './pages/admin/formBuilder';
import FormBuilderForm from './pages/admin/formBuilder/create';
import ViewFormBuilder from './pages/admin/formBuilder/view';
  ...
  },
  {
    ...
    children: [
...

      {
        ...
        element: (
          <ErrorBoundary>
            <ProtectedRoute moduleName='formBuilder'>
              <FormBuilderManagement />
            </ProtectedRoute>
          </ErrorBoundary>
        ),
      },
